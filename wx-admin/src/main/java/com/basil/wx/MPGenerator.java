...
public class MPGenerator {
    //需要配置
    private static final String dbTables = "admin,admin_role,coach,course,permission,reserve,role,role_permission,user,evaluation";             //需要生成的表名
    private static final Boolean enableSwagger = false;                 //是否开启Swagger

    public static void main(String[] args) {
        // 1.数据源配置
        DataSourceConfig dataSourceConfig = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/wx","root","admin").build();
        ...
        globalConfigBuilder.outputDir(projectPath + "/gym-admin" + "/src/main/java");
        // 作者
        globalConfigBuilder.author("Basil");
        // 结束时是否打开文件夹
        ...
        packageConfigBuilder.parent("com.basil.gym"); //项目包名
